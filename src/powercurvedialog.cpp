...
PowerCurveDialog::PowerCurveDialog(QWidget *parent, dSettings &afSettings, int profileId, int curveId)
	: QDialog(parent), ui(new Ui::PowerCurveDialog), afSettings(afSettings), profileId(profileId), curveId(curveId) {
	ui->setupUi(this);
	chart = new QChart();
