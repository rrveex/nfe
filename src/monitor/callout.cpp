...
Callout::Callout(QChart *chart, QXYSeries *series, QColor c) : QGraphicsItem(chart), m_chart(chart), m_series(series), m_color(c) {}
...
void Callout::setText(const QString &text, int pointsize) {
	m_text = text;
	if (pointsize > 0) m_font.setPointSize(pointsize);
